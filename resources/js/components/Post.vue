...
<div class="bg-white rounded shadow w-2/3 mt-6 overflow-hidden">
    ...
    <div class="flex justify-between border-1 border-gray-400 p-4">
        <button class="flex justify-center py-2 items-center rounded-lg text-sm w-full focus:outline-none"
        ...
        <button class="flex justify-center py-2 items-center rounded-lg text-sm text-gray-700 w-full focus:outline-none"
