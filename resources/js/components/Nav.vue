    ...
    <div class="bg-white h-12 px-4 flex items-center">
        <div class="w-1/3">
            <div class="flex">
                ...
                <div class="ml-2 relative">
                    ...
                    <input type="text"
                           name="search"
                           class="w-56 h-8 bg-gray-200 rounded-full focus:outline-none focus:shadow-outline text-sm pl-8"
        ...
        <div class="w-1/3 flex justify-center items-center h-full">
            ...
            <router-link to="/" class="px-6 h-full border-b-2 border-white flex items-center">
                <img class="w-8 h-8 object-cover rounded-full" src="https://lh3.googleusercontent.com/proxy/OoFZ3u04kwDsQyUa2JVmHumg0GjjB2APpU599p_QZBjfV9CiNRwN8-v7LZ3FzBqal4u6e3FoVAmvL5fphvpKgvlnzu1Nfq70q83epmANqWL8qn8i_qis1DL8mDUdsqxFWee6Gtif4Qfya_o" alt="profile image">
            </router-link>
            <router-link to="/" class="px-6 h-full border-b-2 border-white flex items-center">
